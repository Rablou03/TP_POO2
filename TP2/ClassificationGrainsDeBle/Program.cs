using ClassificationGrainsDeBle.Models;
...
namespace ClassificationGrainsDeBle
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("L'application WPF a été lancée.");
            Console.WriteLine("Utilisez l'interface graphique pour la classification.");
